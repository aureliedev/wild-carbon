...
export class Migration1722546447408 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "transportation" ("id" SERIAL NOT NULL, "label" character varying NOT NULL, "carbonEmissionsByGrPerKm" integer NOT NULL, CONSTRAINT "PK_d7f91167cda8f3f83929b7892fb" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "ride" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "label" character varying NOT NULL, "distance" integer NOT NULL, "date" TIMESTAMP NOT NULL, "ownerId" uuid, "transportationId" integer, CONSTRAINT "PK_f6bc30c4dd875370bafcb54af1b" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "ride" ADD CONSTRAINT "FK_5f4bd4790ad311d97bb8e116f0a" FOREIGN KEY ("ownerId") REFERENCES "AppUser"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "ride" ADD CONSTRAINT "FK_bd688ebfce39741d767ca10a751" FOREIGN KEY ("transportationId") REFERENCES "transportation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "ride" DROP CONSTRAINT "FK_bd688ebfce39741d767ca10a751"`
    );
    await queryRunner.query(
      `ALTER TABLE "ride" DROP CONSTRAINT "FK_5f4bd4790ad311d97bb8e116f0a"`
    );
    await queryRunner.query(
